...
interface CheckoutCardProps {
  ...
  discount: number;
  children?: ReactNode; // Include this if your component expects to receive children
}
...
const CheckoutCard: React.FC<CheckoutCardProps> = ({
  ...
  // Delivery charge and coupon calculation
  const deliveryChargeNumber = parseInt(deliveryCharge) || 0;

  const totalPriceWithoutDiscount = total + deliveryChargeNumber;
  const totalPriceWithDiscount = totalPriceWithoutDiscount - discount;
