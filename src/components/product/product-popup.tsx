...
export default function ProductPopup() {
  ...
  const popUpImage = `${process.env.NEXT_PUBLIC_IMAGE_API_ENDPOINT}${data?.image?.thumbnail}`;
  ...
  return (
    <div className=" flex justify-center">
      <div className="rounded-lg bg-white 2xl:w-7/12  xl:w-8/12 md:w-11/12  2xl:p-0 xl-p-0 lg:p-1 md:p-2 sm:p-2 p-1 w-full">
        <div className="flex flex-col lg:flex-row w-full md:w-[650px] lg:w-[960px] mx-auto overflow-hidden">
          <div className="flex-shrink-0 flex items-center justify-center w-full lg:w-430px max-h-470px overflow-hidden lg:max-h-full  bg-gray-300">
            <img
              src={popUpImage}
              alt={name}
            ...
            <div className="pb-5">
              ...
              <div className="flex items-center mt-3">
                {data?.sell_price && data.sell_price === data.price && (
                  <div className="font-bold text-lg">{data.sell_price} TK</div>
                )}
                {data?.sell_price && data.sell_price !== data.price && (
                  <>
