...
export default function Search() {
  ...
  const searchData = data; // Simply assign data to searchData
  ...
  return (
    <div ref={ref}>
      ...
      <div
        className={cn(
          "drawer-search relative hidden top-0 z-40 opacity-0 invisible transition duration-300 ease-in-out left-1/2 px-4 w-full md:w-[730px] lg:w-[930px]",
          {
            open: displaySearch,
          }
        )}
